...
describe("할 일 목록에서 삭제를 할 수 있다.", () => {
  test("5개 할 일이 있는데, id가 3인 할 일을 삭제할 수 있다.", () => {
...
describe("할 일 목록에서 추가를 할 수 있다.", () => {
  test("5개 할 일이 있는데, id가 6인 할 일을 추가할 수 있다.", () => {
    const todoItem6 = new TodoItem(6, "할 일 6", new Date());
...
describe("생성한 할 일들 중 완료/미완료 구분하기", () => {
  test("5개 할 일이 있는데, 2,3번만 완료이다.", () => {
