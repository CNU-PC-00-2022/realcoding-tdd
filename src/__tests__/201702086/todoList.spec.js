...
describe("지난 할 일 중 완료/미완료 구분하기", () => {
    test("5개의 지난 할 일이 있는데, 2번, 3번만 완료다.", () => {
        // 지난 할 일 만들기
        jest.spyOn(todoItem1, "equalsDayOfCreatedAt").mockReturnValue(false);
        jest.spyOn(todoItem2, "equalsDayOfCreatedAt").mockReturnValue(false);
        ...
        //지난 완료가 2개인 것은 알지만 2, 3번인 것은 모르므로 알기 위해 id 조회
    });
