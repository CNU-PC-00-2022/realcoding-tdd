...
describe("할 일 목록에서 할 일을 삭제 할 수 있다.", () => {
...
describe("할 일 목록에서 할 일을 추가 할 수 있다.", () => {
  test("5개의 할 일이 있는데, id가 6인 할 일을 추가할 수 있다.", () => {
    const todoItem6 = new TodoItem(6, '할일 6', new Date());
...
describe("할 일 목록에서 오늘 할 일, 지난 할 일을 구분 할 수 있다.", () => {
  test("5개의 할 일이 있는데, 2번을 뺸 오늘 할 일을 구분 할 수 있다.", () => {
  ...
  test("5개의 할 일이 있는데, 2번만 지난 할 일이고 2번을 구분 할 수 있다.", () => {
...
describe("할 일 목록에서 완료/미완료를 구분 할 수 있다.", () => {
