...
beforeEach(() => {
  ...
  todoList = new TodoList(
    [todoItem1, todoItem2, todoItem3, todoItem4, todoItem5],
    new Date()
  );
});
...
describe("할 일 목록에서 삭제를 할 수 있다.", () => {
  test("5개의 할 일이 있는데, id가 3인 할 일을 삭제 할 수 있 다.", () => {
...
describe("할 일 목록에서 할 일을 추가 할 수 있다.", () => {
  test("5개의 할 일이 있는데, 새로운 할 일을 추가할 수 있다.", () => {
    const todoItem6 = new TodoItem(6, "할 일 1", new Date());
...
describe("오늘 할 일 들중 완료/미완료 구분하기", () => {
...
describe("지난 할 일 들중 완료/미완료 구분하기", () => {
  test("5개의 지난할 일이 있는데, 2번, 3번만 완료다.", () => {
    jest
