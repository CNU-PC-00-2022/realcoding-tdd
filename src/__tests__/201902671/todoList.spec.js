...
describe("오늘 할 일 중에서 완료/미완료 구분할 수 있다.", () => {
  test("5개의 할 일이 있는데, id 2번, 3번만 완료다", () => {
    jest.spyOn(todoItem1, "equalsDayOfCreatedAt").mockImplementation(() => true);
    jest.spyOn(todoItem2, "equalsDayOfCreatedAt").mockImplementation(() => true);
    jest.spyOn(todoItem3, "equalsDayOfCreatedAt").mockImplementation(() => true);
    jest.spyOn(todoItem4, "equalsDayOfCreatedAt").mockImplementation(() => true);
    jest.spyOn(todoItem5, "equalsDayOfCreatedAt").mockImplementation(() => true);
